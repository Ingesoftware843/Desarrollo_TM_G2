...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Administra todas las rutas del sistema de transporte incluyendo su nombre, distancia, mapa referencial, estado y municipalidad a la que pertenece.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Estaciones y Parqueos",
    paragraph:
      "Permite registrar las estaciones y sus capacidades, así como los parqueos disponibles. Cada estación puede asociarse a una línea y zona.",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "Módulo completo para asignar pilotos, guardias y operadores a estaciones, parqueos o líneas específicas, incluyendo turnos, fechas y control de estado.",
  },
  {
    id: 4,
    icon: (
      <svg width="40" height="42" viewBox="0 0 40 42" className="fill-current">
        ...
        />
        <path d="M18.7226 32.6316C18.7226 35.4705 19.8099 38.0969 21.2941 40.2796C21.7904 41.0094 21.3054 42.1053 20.4229 42.1053H4.21053C1.87368 42.1053 0 40.2316 0 37.8947V4.21053C0 1.89474 1.87368 0 4.21053 0H6.31579H16.8421H29.4737C31.7895 0 33.6842 1.87368 33.6842 4.21053V17.9544C33.6842 18.5032 33.1804 18.9474 32.6316 18.9474C25.0737 18.9474 18.9474 25.0737 18.9474 32.6316Z" />
      </svg>
    ),
    title: "Registro de Viajes y Alertas",
    paragraph:
      "Los usuarios pueden registrar sus viajes y consultar el historial. Además, se activan alertas automáticas si hay sobrecupo o baja ocupación en estaciones.",
  },
  {
    id: 5,
    icon: (
    ...
    paragraph:
      "Gestión centralizada de usuarios con roles definidos (Administrador, Piloto, Guardia, Operador, Usuario) y control de accesos basado en privilegios.",
  },
];

...
const ScrollButton = ({ icon, onClick, disabled }: ScrollButtonProps) => {
  ...
  return (
    <button
      ...
      className={cx(
        // base
        "size-5 group inline-flex items-center truncate rounded-sm transition",
        disabled
        ...
        <div className={cx("space-y-1 px-4 py-2")}>
          {payload.map(({ value, category, color }, index) => (
            ...
            >
              ...
              >
                {/* Formateo de Valor a moneda  {valueFormatter(value)}*/}
                {value}
              </p>
            </div>
          ))}
      ...
      >
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cx("stroke-gray-200 stroke-2 dark:stroke-gray-900")}
            ...
            <XAxis
              ...
              className={cx(
                ...
                "text-xs",
                // text fill
                "fill-gray-500 dark:fill-gray-100",
